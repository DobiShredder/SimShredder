...
export function TopGearResultsPanel({ result, picker }: { result: TopGearResultView; picker: ReactNode }) {
  ...
  const tooltip = (item: ItemVariant) => itemTooltipModel({
    ...
    title: t("tooltip.itemTitle", { id: item.sourceItemId }),
